...
export interface RegionResponse {
  ...
  firstChoiceSuccessRate: number | null; //Average sucess rate on first choice (uchazec_volba where poradi = 1 and prijat = 1)
  secondChoiceSuccessRate: number | null; //Average sucess rate on second choice (uchazec_volba where poradi = 2 and prijat = 1)
